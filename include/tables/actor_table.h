...
/* 0x0001 */ DEFINE_ACTOR(Transform_Baby_Gohma, ACTOR_TRANSFORM_BABY_GOHMA, ACTOROVL_ALLOC_NORMAL, "Transform_Baby_Gohma")
/* 0x0002 */ DEFINE_ACTOR(En_Test, ACTOR_EN_TEST, ACTOROVL_ALLOC_NORMAL, "En_Test")
/* 0x0003 */ DEFINE_ACTOR(Transform_Gohma, ACTOR_TRANSFORM_GOHMA, ACTOROVL_ALLOC_NORMAL, "Transform_Gohma")
/* 0x0004 */ DEFINE_ACTOR(En_GirlA, ACTOR_EN_GIRLA, ACTOROVL_ALLOC_NORMAL, "En_GirlA")
/* 0x0005 */ DEFINE_ACTOR(Popcorn, ACTOR_POPCORN, ACTOROVL_ALLOC_NORMAL, "Popcorn")
/* 0x0006 */ DEFINE_ACTOR(Prop_Hand, ACTOR_PROP_HAND, ACTOROVL_ALLOC_NORMAL, "Prop_Hand")
...
/* 0x0017 */ DEFINE_ACTOR(Hm_Comp_Objects, ACTOR_HM_COMP_OBJECTS, ACTOROVL_ALLOC_NORMAL, "Hm_Comp_Objects")
...
/* 0x001A */ DEFINE_ACTOR(Hm_Comp_Boss, ACTOR_HM_COMP_BOSS, ACTOROVL_ALLOC_NORMAL, "Hm_Comp_Boss")
...
/* 0x0073 */ DEFINE_ACTOR(Transform_Ik, ACTOR_TRANSFORM_IK, ACTOROVL_ALLOC_NORMAL, "Transform_Ik")
/* 0x0074 */ DEFINE_ACTOR(Transform_Octorok, ACTOR_TRANSFORM_OCTOROK, ACTOROVL_ALLOC_NORMAL, "Transform_Octorok")
/* 0x0075 */ DEFINE_ACTOR(Transform_Keese, ACTOR_TRANSFORM_KEESE, ACTOROVL_ALLOC_NORMAL, "Transform_Keese")/* 0x0076 */ DEFINE_ACTOR_UNSET(ACTOR_UNSET_76)
