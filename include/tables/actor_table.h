...
/* 0x0075 */ DEFINE_ACTOR(Transform_Keese, ACTOR_TRANSFORM_KEESE, ACTOROVL_ALLOC_NORMAL, "Transform_Keese")
...
/* 0x007A */ DEFINE_ACTOR(Vine_Spot, ACTOR_VINE_SPOT, ACTOROVL_ALLOC_NORMAL, "Vine_Spot")
/* 0x007B */ DEFINE_ACTOR(Ice_Block, ACTOR_ICE_BLOCK, ACTOROVL_ALLOC_NORMAL, "Ice_Block")
...
/* 0x009F */ DEFINE_ACTOR(Magic_Fire, ACTOR_MAGIC_FIRE, ACTOROVL_ALLOC_NORMAL, "Magic_Fire")
...
/* 0x010A */ DEFINE_ACTOR(Arrow_Fire, ACTOR_ARROW_FIRE, ACTOROVL_ALLOC_NORMAL, "Arrow_Fire")
/* 0x010B */ DEFINE_ACTOR(Arrow_Ice, ACTOR_ARROW_ICE, ACTOROVL_ALLOC_NORMAL, "Arrow_Ice")
/* 0x010C */ DEFINE_ACTOR(Arrow_Light, ACTOR_ARROW_LIGHT, ACTOROVL_ALLOC_NORMAL, "Arrow_Light")
