...
/* 0x0005 */ DEFINE_ACTOR(Ice_Block, ACTOR_ICE_BLOCK, ALLOCTYPE_NORMAL)
/* 0x0006 */ DEFINE_ACTOR(Light_Ball, ACTOR_MAGIC_CONSERVE, ALLOCTYPE_ABSOLUTE)
...
/* 0x0017 */ DEFINE_ACTOR(Vine_Spot, ACTOR_VINE_SPOT, ALLOCTYPE_NORMAL)
...
/* 0x0109 */ DEFINE_ACTOR(Arrow_Shadow, ACTOR_ARROW_SHADOW, ALLOCTYPE_ABSOLUTE)
...
/* 0x010D */ DEFINE_ACTOR(Arrow_Bomb, ACTOR_ARROW_BOMB, ALLOCTYPE_ABSOLUTE)
/* 0x010E */ DEFINE_ACTOR(Arrow_Teleport, ACTOR_ARROW_FOREST, ALLOCTYPE_ABSOLUTE)
...
/* 0x0180 */ DEFINE_ACTOR(Spinner, ACTOR_SPINNER, ALLOCTYPE_NORMAL)   //DEFINE_ACTOR_UNSET(ACTOR_UNSET_180)
