...
Vtx gBeamLaserVtx[] = {
	VTX(-144, 145, 700, 0, 256, 255, 255, 255, 255),
	VTX(139, -138, 700, 256, 256, 255, 255, 255, 255),
	VTX(139, -138, 0, 256, -2328, 255, 255, 255, 255),
	VTX(-144, 145, 0, 0, -2328, 255, 255, 255, 255),
	VTX(144, 145, 0, 0, -2328, 255, 255, 255, 255),
	VTX(-139, -138, 0, 256, -2328, 255, 255, 255, 255),
	VTX(144, 145, 700, 0, 256, 255, 255, 255, 255),
	VTX(-139, -138, 700, 256, 256, 255, 255, 255, 255),
...
Gfx gBeamLaserDL[] = {
    ...
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gBeamLaserTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                         | G_TX_WRAP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, 1, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
    gsDPSetRenderMode(G_RM_PASS, G_RM_AA_ZB_OPA_SURF2),
    gsSPClearGeometryMode(G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
Gfx gPopcornDL[] = {
    ...
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gPopcornTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP,
