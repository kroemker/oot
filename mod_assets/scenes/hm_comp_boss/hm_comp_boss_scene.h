...
extern Vec3s hm_comp_boss_scene_vertices[28];
extern CollisionPoly hm_comp_boss_scene_polygons[46];
...
extern Vtx hm_comp_boss_room_0_dl_Floor_mesh_layer_Opaque_vtx_0[12];
