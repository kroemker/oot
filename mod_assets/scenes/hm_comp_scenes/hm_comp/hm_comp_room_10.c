...
Vtx hm_comp_dl_Plane_007_mesh_layer_Opaque_vtx_cull[8] = {
	{{ {-5670, 20, -858}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5670, 20, -858}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5670, 20, -878}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5670, 20, -878}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5650, 20, -858}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5650, 20, -858}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5650, 20, -878}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5650, 20, -878}, 0, {0, 0}, {0, 0, 0, 0} }},
};

Vtx hm_comp_dl_Plane_007_mesh_layer_Opaque_vtx_0[4] = {
	{{ {-5670, 20, -858}, 0, {-16, 1008}, {0, 127, 0, 255} }},
	{{ {-5650, 20, -858}, 0, {1008, 1008}, {0, 127, 0, 255} }},
	{{ {-5650, 20, -878}, 0, {1008, -16}, {0, 127, 0, 255} }},
	{{ {-5670, 20, -878}, 0, {-16, -16}, {0, 127, 0, 255} }},
};
