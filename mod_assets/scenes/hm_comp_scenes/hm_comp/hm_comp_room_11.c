...
Vtx hm_comp_dl_Plane_008_mesh_layer_Opaque_vtx_cull[8] = {
	{{ {-5738, -58, -944}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5738, -58, -944}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5738, -58, -964}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5738, -58, -964}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5718, -58, -944}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5718, -58, -944}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5718, -58, -964}, 0, {0, 0}, {0, 0, 0, 0} }},
	{{ {-5718, -58, -964}, 0, {0, 0}, {0, 0, 0, 0} }},
};

Vtx hm_comp_dl_Plane_008_mesh_layer_Opaque_vtx_0[4] = {
	{{ {-5738, -58, -944}, 0, {-16, 1008}, {0, 127, 0, 255} }},
	{{ {-5718, -58, -944}, 0, {1008, 1008}, {0, 127, 0, 255} }},
	{{ {-5718, -58, -964}, 0, {1008, -16}, {0, 127, 0, 255} }},
	{{ {-5738, -58, -964}, 0, {-16, -16}, {0, 127, 0, 255} }},
};

Gfx hm_comp_dl_Plane_008_mesh_layer_Opaque_tri_0[] = {
	gsSPVertex(hm_comp_dl_Plane_008_mesh_layer_Opaque_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Gfx mat_hm_comp_dl_f3dlite_material_009_layerOpaque[] = {
	gsDPPipeSync(),
...
Gfx hm_comp_dl_Plane_008_mesh_layer_Opaque[] = {
	...
	gsSPDisplayList(mat_hm_comp_dl_f3dlite_material_009_layerOpaque),
