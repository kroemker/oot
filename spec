...
beginseg
    name "ovl_Transform_Gohma"
    compress
    include "$(BUILD_DIR)/src/overlays/actors/ovl_Transform_Gohma/z_transform_gohma.o"
    include "$(BUILD_DIR)/src/overlays/actors/ovl_Transform_Gohma/ovl_Transform_Gohma_reloc.o"
endseg
