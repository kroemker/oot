...
ActorOverlay gActorOverlayTable[] = {
    ...
    ACTOR_OVERLAY(Ice_Block, ALLOCTYPE_NORMAL),
    ACTOR_OVERLAY(Light_Ball, ALLOCTYPE_ABSOLUTE),
    ...
    ACTOR_OVERLAY(Arrow_Bomb, ALLOCTYPE_ABSOLUTE),
    ACTOR_OVERLAY(Arrow_Teleport, ALLOCTYPE_ABSOLUTE),
