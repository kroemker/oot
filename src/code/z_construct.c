...
void Interface_Init(PlayState* play) {
    ...
    PRINTF("Permanent PARAMETER Segment = %x=%x\n", parameterSize);
    ...
    PRINTF("Icon Item Texture Initialization = %x=%x\n", ICON_ITEM_SEGMENT_SIZE);
