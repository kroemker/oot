...
void Interface_SetSceneRestrictions(PlayState* play) {
    ...
    PRINTF("Data settings related to button display scene_data_ID=%d\n", play->sceneId);
...
u8 Item_Give(PlayState* play, u8 item) {
    ...
    if ((item >= ITEM_MEDALLION_FOREST) && (item <= ITEM_MEDALLION_LIGHT)) {
        ...
        if (gSaveContext.save.info.inventory.items[slot] == ITEM_NONE) {
            ...
            PRINTF("Deku Nuts %d(%d)=%d BS_count=%d %d(%d)=%d  BS_count=%d\n", item, ITEM_DEKU_NUTS_5, item - ITEM_DEKU_NUTS_5,
        ...
        if ((item != ITEM_BOTTLE_MILK_FULL) && (item != ITEM_BOTTLE_RUTOS_LETTER)) {
            ...
            for (i = 0; i < 4; i++) {
                if (gSaveContext.save.info.inventory.items[temp + i] == ITEM_BOTTLE_EMPTY) {
                    PRINTF("Item_Pt(1)=%d Item_Pt(2)=%d Item_Pt(3)=%d   Empty Bottle=%d   Content=%d\n",
...
u8 Item_CheckObtainability(u8 item) {
    ...
    if ((item >= ITEM_MEDALLION_FOREST) && (item <= ITEM_MEDALLION_LIGHT)) {
        ...
        PRINTF("Magic Pot Get_Inf_Table( 25, 0x0100)=%d\n", GET_INFTABLE(INFTABLE_198));
        if (!GET_INFTABLE(INFTABLE_198)) {
            return ITEM_NONE;
        } else {
            return item;
...
s32 Health_ChangeBy(PlayState* play, s16 amount) {
    ...
    PRINTF("＊＊＊＊＊  ＊＊＊＊＊ Fluctuation=%d (now=%d, max=%d) ＊＊＊=%d (now=%d, max=%d)  ＊＊＊", amount, gSaveContext.save.info.playerData.health,
    ...
    if (amount > 0) { Audio_PlaySfxGeneral(NA_SE_SY_HP_RECOVER, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale,
        ...
        amount >>= 1;
        PRINTF("Heart decrease halved!!＝%d！！＝%d\n", amount); // "Heart decrease halved!!＝%d"
    }
    // clang-format on
...
static u8 sDPadIcon[] = {
    ...
    ,
...
void Interface_DrawDPad(PlayState* play) {
    InterfaceContext* interfaceCtx = &play->interfaceCtx;
    u32 tlx = (R_ITEM_BTN_X(2) + 24) << 2;
    u32 tly = (R_ITEM_BTN_Y(2) + 40) << 2;
    u32 brx = (R_ITEM_BTN_X(2) + 24 + 16) << 2;
    u32 bry = (R_ITEM_BTN_Y(2) + 40 + 16) << 2;
    u32 loffset = 60;
    u32 roffset = 55;
    u32 uoffset = 60;
    ...
    if (gSaveContext.rupeeAccumulator != 0) {
        if (gSaveContext.rupeeAccumulator > 0) {
            if (gSaveContext.save.info.playerData.rupees < CUR_CAPACITY(UPG_WALLET)) {
                ...
                PRINTF("Rupee Amount MAX = %dＭＡＸ = %d\n", CUR_CAPACITY(UPG_WALLET));
