...
void BgHidanKowarerukabe_Init(Actor* thisx, PlayState* play) {
    ...
    if (((this->dyna.actor.params & 0xFF) < CRACKED_STONE_FLOOR) ||
        ...
        PRINTF("Error : Error: Fire Temple Breakable Walls. arg_data I can't determine the (%s %d)(arg_data 0x%04x)\n",
    ...
    PRINTF("(hidan (fire walls, floors, destroyed by bombs)(arg_data 0x%04x)\n", this->dyna.actor.params);
}
