...
static DamageTable sDamageTable = {
    ...
    /* Unblockable   */ DMG_ENTRY(8, AM_DMGEFF_NONE),
    /* Hammer jump   */ DMG_ENTRY(4, AM_DMGEFF_KILL),
    /* Unknown 2     */ DMG_ENTRY(15, AM_DMGEFF_NONE),
};
...
void EnAm_Statue(EnAm* this, PlayState* play) {
    ...
    if (this->unk_258 == 0) {
        ...
        if ((this->dyna.unk_150 == 0.0f) || (this->unk_258 == 0) ||
            ...
            this->unk_258 = 0;
            player->stateFlags2 &= ~(PLAYER_STATE2_0 | PLAYER_STATE2_4 | PLAYER_STATE2_ALWAYS_DISABLE_MOVE_ROTATION | PLAYER_STATE2_8);
