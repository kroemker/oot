...
void EnHeishi2_Init(Actor* thisx, PlayState* play) {
    ...
    if ((this->type == 6) || (this->type == 9)) {
        ...
        switch (this->type) {
            ...
            case 6:
                PRINTF("\n\n");
                PRINTF(VT_FGCOL(GREEN) " ☆☆☆☆☆ Peep hole soldier! ☆☆☆☆☆ \n" VT_RST);
        ...
        PRINTF("\n\n");
        PRINTF(VT_FGCOL(GREEN) " ☆☆☆☆☆ Soldier Set 2 Completed!！ ☆☆☆☆☆ %d\n" VT_RST, this->actor.params);
        PRINTF(VT_FGCOL(YELLOW) " ☆☆☆☆☆ Identification Completed!！         ☆☆☆☆☆ %d\n" VT_RST, this->type);
        PRINTF(VT_FGCOL(MAGENTA) " ☆☆☆☆☆ Message completed!！   ☆☆☆☆☆ %x\n\n" VT_RST, (this->actor.params >> 8) & 0xF);
    }
}
...
void func_80A53278(EnHeishi2* this, PlayState* play) {
    ...
    if (MaskReaction_GetTextId(play, MASK_REACTION_SET_HYRULIAN_GUARD) != 0) {
        ...
        PRINTF(VT_FGCOL(GREEN) " ☆☆☆☆☆ Get all spiritual stones!GET！ ☆☆☆☆☆ \n" VT_RST);
        this->unk_300 = TEXT_STATE_DONE;
        this->actor.textId = 0x7006;
        this->actionFunc = func_80A5475C;
    } else if (!IS_DAY) {
        PRINTF(VT_FGCOL(YELLOW) " ☆☆☆☆☆ Sleep early for children!！ ☆☆☆☆☆ \n" VT_RST);
        this->unk_300 = TEXT_STATE_DONE;
        this->actor.textId = 0x7002;
        this->actionFunc = func_80A5475C;

    } else if (this->unk_30C != 0) {
        PRINTF(VT_FGCOL(BLUE) " ☆☆☆☆☆ Anything passes ☆☆☆☆☆ \n" VT_RST);
        this->unk_300 = TEXT_STATE_DONE;
        this->actor.textId = 0x7099;
        this->actionFunc = func_80A5475C;
    } else if (GET_EVENTCHKINF(EVENTCHKINF_RECEIVED_WEIRD_EGG)) {
        if (this->unk_30E == 0) {
            PRINTF(VT_FGCOL(MAGENTA) " ☆☆☆☆☆ １Start under the first sleeve!！ ☆☆☆☆☆ \n" VT_RST);
            this->actor.textId = 0x7071;
            this->unk_30E = 1;
        } else {
            PRINTF(VT_FGCOL(MAGENTA) " ☆☆☆☆☆ ２Start under the second sleeve!！ ☆☆☆☆☆ \n" VT_RST);
        ...
        PRINTF(VT_FGCOL(CYAN) " ☆☆☆☆☆ That's okay ☆☆☆☆☆ \n" VT_RST);
        this->unk_300 = TEXT_STATE_DONE;
...
void func_80A53638(EnHeishi2* this, PlayState* play) {
    ...
    if (this->unk_2EC <= frameCount) {
        ...
        PRINTF(VT_FGCOL(MAGENTA) "☆☆☆ I've come!！ ☆☆☆ %x\n" VT_RST, actor->dyna.actor.next);
...
void func_80A5399C(EnHeishi2* this, PlayState* play) {
    ...
    if (GET_INFTABLE(INFTABLE_76)) {
        ...
        PRINTF(VT_FGCOL(MAGENTA) " ☆☆☆☆☆ I don't know ☆☆☆☆☆ \n" VT_RST);
...
void func_80A5455C(EnHeishi2* this, PlayState* play) {
    ...
    if ((Message_GetState(&play->msgCtx) == TEXT_STATE_EVENT) && Message_ShouldAdvance(play)) {
        ...
        PRINTF(VT_FGCOL(YELLOW) " ☆☆☆☆☆ This is down!！ ☆☆☆☆☆ \n" VT_RST);
