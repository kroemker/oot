...
static DamageTable sDamageTable = {
    ...
    /* Deku stick    */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Slingshot     */ DMG_ENTRY(0, EN_IK_DMGEFF_PROJECTILE),
    /* Explosive     */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Boomerang     */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Normal arrow  */ DMG_ENTRY(0, EN_IK_DMGEFF_PROJECTILE),
    /* Hammer swing  */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Hookshot      */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Kokiri sword  */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Master sword  */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Giant's Knife */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Fire arrow    */ DMG_ENTRY(0, EN_IK_DMGEFF_PROJECTILE),
    /* Ice arrow     */ DMG_ENTRY(0, EN_IK_DMGEFF_PROJECTILE),
    /* Light arrow   */ DMG_ENTRY(0, EN_IK_DMGEFF_PROJECTILE),
    /* Unk arrow 1   */ DMG_ENTRY(0, EN_IK_DMGEFF_PROJECTILE),
    /* Unk arrow 2   */ DMG_ENTRY(0, EN_IK_DMGEFF_PROJECTILE),
    /* Unk arrow 3   */ DMG_ENTRY(0, EN_IK_DMGEFF_PROJECTILE),
    ...
    /* Kokiri spin   */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Giant spin    */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Master spin   */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Kokiri jump   */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Giant jump    */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Master jump   */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Unknown 1     */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Unblockable   */ DMG_ENTRY(3, EN_IK_DMGEFF_DAMAGE),
    /* Hammer jump   */ DMG_ENTRY(0, EN_IK_DMGEFF_SPARKS_NO_DMG),
    /* Unknown 2     */ DMG_ENTRY(5, EN_IK_DMGEFF_DAMAGE),
};
