...
void EnOkarinaTag_Init(Actor* thisx, PlayState* play) {
    ...
    PRINTF("\n\n");
    PRINTF(VT_FGCOL(GREEN) "☆☆☆☆☆ Ocarina tag outbreak ☆☆☆☆☆ %x\n" VT_RST, this->actor.params);
    ...
    PRINTF(VT_FGCOL(GREEN) "☆☆☆☆☆ Save information\t ☆☆☆☆☆ %d\n" VT_RST, this->switchFlag);
    PRINTF(VT_FGCOL(YELLOW) "☆☆☆☆☆ Type index ☆☆☆☆☆ %d\n" VT_RST, this->type);
    PRINTF(VT_FGCOL(MAGENTA) "☆☆☆☆☆ Correct answer information\t ☆☆☆☆☆ %d\n" VT_RST, this->ocarinaSong);
    PRINTF(VT_FGCOL(CYAN) "☆☆☆☆☆ Range information\t ☆☆☆☆☆ %d\n" VT_RST, this->actor.world.rot.z);
    PRINTF(VT_FGCOL(CYAN) "☆☆☆☆☆ Processing range information\t ☆☆☆☆☆ %f\n" VT_RST, this->interactRange);
    PRINTF(VT_FGCOL(GREEN) "☆☆☆☆☆ Hit?？\t\t ☆☆☆☆☆ %d\n" VT_RST, this->unk_158);
    PRINTF("\n\n");
            ...
            if (player->stateFlags2 & PLAYER_STATE2_24) {
                switch (this->type) {
                    ...
                    case 6:
                        ...
                        break;
                    default:
                        PRINTF(VT_FGCOL(GREEN) "☆☆☆☆☆ Ocarina Invisible-kun demo start check error source ☆☆☆☆☆ %d\n" VT_RST,
                               this->type);
                        Actor_Kill(&this->actor);
                        break;
                }
...
void func_80ABF7CC(EnOkarinaTag* this, PlayState* play) {
    PRINTF(VT_FGCOL(MAGENTA) "☆☆☆☆☆ Open sesame sesame!！ ☆☆☆☆☆ %d\n" VT_RST, Message_GetState(&play->msgCtx));
