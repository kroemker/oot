...
void suaf_debug(Player* this, UpperActionFunc func, const char* name) {
    this->debugUpperActionFuncName = name;
    Player_SetUpperActionFunc(this, func);
}

s32 Player_SetupAction(PlayState* play, Player* this, PlayerActionFunc actionFunc, s32 flags);

s32 saf_debug(PlayState* play, Player* this, PlayerActionFunc func, s32 flags, const char* name) {
    this->debugActionFuncName = name;
...
static GetItemEntry sGetItemTable[] = {
    ...
    // GI_BOOMERANG
    GET_ITEM(ITEM_HAMMERANG, OBJECT_GI_HAMMER, GID_HAMMER, 0x38, 0x80, CHEST_ANIM_LONG),
    // GI_DEKU_STICKS_1
    ...
    GET_ITEM_NONE,
    // GI_TEXT_0
    GET_ITEM(ITEM_KEESE_SOUL, OBJECT_GI_SUTARU, GID_SOUL_KEESE, 0x3C, 0x80, CHEST_ANIM_LONG),
    // GI_SOUL_IK
    GET_ITEM(ITEM_IK_SOUL, OBJECT_GI_SUTARU, GID_SOUL_IK, 0x3A, 0x80, CHEST_ANIM_LONG),
    GET_ITEM(ITEM_OCTOROK_SOUL, OBJECT_GI_SUTARU, GID_SOUL_OCTOROK, 0x3B, 0x80, CHEST_ANIM_LONG),
};
...
LinkAnimationHeader* func_80833438(Player* this) {
    ...
    } else if (!(this->stateFlags1 & (PLAYER_STATE1_27 | PLAYER_STATE1_IN_CUTSCENE)) &&
...
void Player_InitItemActionWithAnim(PlayState* play, Player* this, s8 itemAction) {
    ...
    this->stateFlags1 &= ~(PLAYER_STATE1_AIMING_FPS_ITEM | PLAYER_STATE1_24);
...
s32 func_80833B2C(Player* this) {
    if (this->stateFlags1 & (PLAYER_STATE1_FORCE_STRAFING | PLAYER_STATE1_17 | PLAYER_STATE1_30)) {
        return 1;
    } else {
        return 0;
    }
...
s32 func_80833B54(Player* this) {
    if ((this->zTargetActor != NULL) && CHECK_FLAG_ALL(this->zTargetActor->flags, ACTOR_FLAG_0 | ACTOR_FLAG_2)) {
...
void Player_Action_TransformBack(Player* this, PlayState* play) {
    ...
    if (play->envCtx.screenFillColor[3] == 255) {
        ...
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_TransformEnd, 0);
    }
}
...
void Player_Action_Transform(Player* this, PlayState* play) {
    ...
    if (play->envCtx.screenFillColor[3] == 255) {
        this->transformActor = Actor_Spawn(&play->actorCtx, play, this->av1.actionVar1, this->actor.world.pos.x, this->actor.world.pos.y,
                    this->actor.world.pos.z, this->actor.world.rot.x, this->actor.world.rot.y, this->actor.world.rot.z, this->isBurning);
        ...
        if (this->transformActor != NULL) {
            ...
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_Transformed, 0);
        }
        else {
            Sfx_PlaySfxCentered(NA_SE_SY_ERROR);
            func_8083A060(this, play); //return to stand still
...
u32 sSfxCounter = NA_SE_VO_LI_MAGIC_FROL;
...
void Player_StartChangingHeldItem(Player* this, PlayState* play) {
    ...
    PLAYER_SETUPPERACTIONFUNC_DEBUG(this, Player_UpperAction_ChangeHeldItem);
...
s32 func_8083442C(Player* this, PlayState* play) {
    ...
    if ((this->heldItemAction >= PLAYER_IA_BOW_FIRE) && (this->heldItemAction <= PLAYER_IA_BOW_0E) &&
        ...
        PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_808351D4);
            ...
            if (!Player_HoldsHookshot(this) && (func_80834380(play, this, &item, &arrowType) > 0)) {
                ...
                if (this->unk_860 >= 0) {
                    if ((magicArrowType >= 0) && (magicArrowType <= 2) &&
                        !Magic_RequestChange(play, sMagicArrowCosts[magicArrowType], MAGIC_CONSUME_WAIT_PREVIEW)) {
...
void func_80834644(PlayState* play, Player* this) {
    ...
    PLAYER_SETUPPERACTIONFUNC_DEBUG(this, sItemActionUpdateFuncs[this->heldItemAction]);
    this->unk_834 = 0;
    this->unk_6AC = 0;
    Player_DetachHeldActor(play, this);
    this->stateFlags1 &= ~PLAYER_STATE1_START_CHANGING_HELD_ITEM;
...
LinkAnimationHeader* func_808346C4(PlayState* play, Player* this) {
    PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_80834B5C);
    Player_DetachHeldActor(play, this);
...
s32 func_80834758(PlayState* play, Player* this) {
    ...
    if (!(this->stateFlags1 & (PLAYER_STATE1_22 | PLAYER_STATE1_23 | PLAYER_STATE1_IN_CUTSCENE)) &&
...
void func_80834894(Player* this) {
    PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_80834C74);
...
s32 func_80834D2C(Player* this, PlayState* play) {
    ...
    if (this->heldItemAction != PLAYER_IA_BOOMERANG) {
        ...
        PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_80835884);
        this->unk_834 = 10;
...
s32 func_808351D4(Player* this, PlayState* play) {
    ...
    if ((this->unk_836 > 0) && ((this->unk_860 < 0) || (!sHeldItemButtonIsHeldDown && !func_80834E7C(play)))) {
        PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_808353D8);
        if (this->unk_860 >= 0) {
            if (sp2C == 0) {
...
s32 func_808353D8(Player* this, PlayState* play) {
    ...
    if (!func_80834758(play, this) &&
        ...
        if (Player_HoldsHookshot(this)) {
            PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_8083501C);
        } else {
            PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_80835588);
...
void func_80835688(Player* this, PlayState* play) {
    if (!func_80835644(play, this, this->heldActor)) {
        PLAYER_SETUPPERACTIONFUNC_DEBUG(this, Player_UpperAction_CarryActor);
...
s32 func_80835800(Player* this, PlayState* play) {
    ...
    if (this->stateFlags1 & PLAYER_STATE1_25) {
        PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_80835B60);
...
s32 func_80835884(Player* this, PlayState* play) {
    if (LinkAnimation_Update(play, &this->upperSkelAnime)) {
        PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_808358F0);
...
s32 func_808358F0(Player* this, PlayState* play) {
    ...
    if (!sHeldItemButtonIsHeldDown) {
        PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_808359FC);
...
s32 func_808359FC(Player* this, PlayState* play) {
    if (LinkAnimation_Update(play, &this->upperSkelAnime)) {
        ...
        s32 yaw = (this->zTargetActor != NULL) ? this->actor.shape.rot.y + 14000 : this->actor.shape.rot.y;
        EnBoom* boomerang =
        ...
        if (boomerang != NULL) {
            boomerang->moveTo = this->zTargetActor;
...
s32 func_80835B60(Player* this, PlayState* play) {
    ...
    if (!(this->stateFlags1 & PLAYER_STATE1_25)) {
        PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_80835C08);
...
s32 func_80835C08(Player* this, PlayState* play) {
    if (!func_80835800(this, play) && LinkAnimation_Update(play, &this->upperSkelAnime)) {
        PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_80835800);
    }
...
s32 Player_SetupAction(PlayState* play, Player* this, PlayerActionFunc actionFunc, s32 flags) {
    ...
    this->stateFlags1 &= ~(PLAYER_STATE1_END_HOOKSHOT_MOVE | PLAYER_STATE1_6 | PLAYER_STATE1_26 | PLAYER_STATE1_28 | PLAYER_STATE1_IN_CUTSCENE |
                           PLAYER_STATE1_31);
...
void func_80835DAC(PlayState* play, Player* this, PlayerActionFunc actionFunc, s32 flags) {
    ...
    this->skelAnime.moveFlags = 0;
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, actionFunc, flags);
...
void func_80836448(PlayState* play, Player* this, LinkAnimationHeader* anim) {
    ...
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, cond ? Player_Action_8084E368 : Player_Action_80843CEC, 0);
...
s32 Player_UpdateUpperBody(Player* this, PlayState* play) {
    if (!(this->stateFlags1 & PLAYER_STATE1_23) && (this->actor.parent != NULL) && Player_HoldsHookshot(this)) {
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80850AEC, 1);
...
s32 func_80836898(PlayState* play, Player* this, PlayerFuncA74 func) {
    this->func_A74 = func;
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_808458D0, 0);
...
void func_808368EC(Player* this, PlayState* play) {
    ...
    if (!(this->stateFlags2 & (PLAYER_STATE2_5 | PLAYER_STATE2_ALWAYS_DISABLE_MOVE_ROTATION))) {
        if ((this->zTargetActor != NULL) &&
            ((play->actorCtx.targetCtx.unk_4B != 0) || (this->actor.category != ACTORCAT_PLAYER))) {
            Math_ScaledStepToS(&this->actor.shape.rot.y,
                               Math_Vec3f_Yaw(&this->actor.world.pos, &this->zTargetActor->focus.pos), 4000);
        } else if ((this->stateFlags1 & PLAYER_STATE1_17) &&
                   !(this->stateFlags2 & (PLAYER_STATE2_5 | PLAYER_STATE2_ALWAYS_DISABLE_MOVE_ROTATION))) {
...
void func_80836BEC(Player* this, PlayState* play) {
    ...
    if ((play->csCtx.state != CS_STATE_IDLE) || (this->csAction != PLAYER_CSACTION_NONE) ||
        (this->stateFlags1 & (PLAYER_STATE1_7 | PLAYER_STATE1_IN_CUTSCENE)) || (this->stateFlags3 & PLAYER_STATE3_7)) {
        this->unk_66C = 0;
        ...
        if (!cond) {
            if (!(this->stateFlags1 & PLAYER_STATE1_25) &&
                ...
                if ((actorToTarget != NULL) && !(actorToTarget->flags & ACTOR_FLAG_27)) {
                    if ((actorToTarget == this->zTargetActor) && (this->actor.category == ACTORCAT_PLAYER)) {
                        actorToTarget = play->actorCtx.targetCtx.unk_94;
                    }

                    if (actorToTarget != this->zTargetActor) {
                        if (!holdTarget) {
                            this->stateFlags2 |= PLAYER_STATE2_13;
                        }
                        this->zTargetActor = actorToTarget;
                        this->unk_66C = 15;
            ...
            if (this->zTargetActor != NULL) {
                if ((this->actor.category == ACTORCAT_PLAYER) && (this->zTargetActor != this->unk_684) &&
                    func_8002F0C8(this->zTargetActor, this, sp1C)) {
                    func_8008EDF0(this);
                    this->stateFlags1 |= PLAYER_STATE1_30;
                } else if (this->zTargetActor != NULL) {
                    this->zTargetActor->targetPriority = 40;
                }
            } else if (this->unk_684 != NULL) {
                this->zTargetActor = this->unk_684;
            }
        }

        if (this->zTargetActor != NULL) {
            this->stateFlags1 &= ~(PLAYER_STATE1_FORCE_STRAFING | PLAYER_STATE1_17);
            if ((this->stateFlags1 & PLAYER_STATE1_HOLDING_ACTOR) ||
                !CHECK_FLAG_ALL(this->zTargetActor->flags, ACTOR_FLAG_0 | ACTOR_FLAG_2)) {
        ...
        *outYawTarget = this->actor.shape.rot.y;
        ...
        if (this->zTargetActor != NULL) {
            if ((play->actorCtx.targetCtx.unk_4B != 0) && !(this->stateFlags2 & PLAYER_STATE2_ALWAYS_DISABLE_MOVE_ROTATION)) {
                *outYawTarget = Math_Vec3f_Yaw(&this->actor.world.pos, &this->zTargetActor->focus.pos);
                return false;
            }
...
s32 Player_TryActionChangeList(PlayState* play, Player* this, s8* actionChangeList, s32 updateUpperBody) {
    ...
    if (!(this->stateFlags1 & (PLAYER_STATE1_EXITING_SCENE | PLAYER_STATE1_7 | PLAYER_STATE1_IN_CUTSCENE))) {
        if (updateUpperBody) {
...
void func_808377DC(PlayState* play, Player* this) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80844E68, 1);
...
void func_80837948(PlayState* play, Player* this, s32 arg2) {
    ...
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_808502D0, 0);
    this->unk_844 = 8;
...
void func_80837B9C(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084411C, 0);
...
void func_80837C0C(PlayState* play, Player* this, s32 arg2, f32 arg3, f32 arg4, s16 arg5, s32 arg6) {
    ...
    if (arg2 == 3) {
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084FB10, 0);
        ...
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084FBF4, 0);
        ...
        if (this->stateFlags1 & PLAYER_STATE1_27) {
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084E30C, 0);
            ...
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084377C, 0);
            ...
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084370C, 0);
            func_80833C3C(this);
                ...
                if (!Player_IsChildWithHylianShield(this)) {
                    if (this->invincibilityTimer >= 0) {
                        ...
                        if (!func_808332B8(this)) {
                            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_808435C4, 0);
                        }

                        if (!(this->av1.actionVar1 = sp54)) {
                            PLAYER_SETUPPERACTIONFUNC_DEBUG(this, func_80834BD4);
...
void func_80838940(Player* this, LinkAnimationHeader* anim, f32 arg2, PlayState* play, u16 sfxId) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084411C, 1);
...
s32 Player_ActionChange_12(Player* this, PlayState* play) {
    ...
    if (!(this->stateFlags1 & PLAYER_STATE1_HOLDING_ACTOR) && (this->ledgeClimbType >= PLAYER_LEDGE_CLIMB_2) &&
        ...
        if (sp3C != 0) {
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80845668, 0);
...
void func_80838E70(PlayState* play, Player* this, f32 arg2, s16 arg3) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80845CA4, 0);
    func_80832440(play, this);
...
void func_80838F18(PlayState* play, Player* this) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084D610, 0);
    Player_AnimChangeLoopSlowMorph(play, this, &gPlayerAnim_link_swimer_swim_wait);
}

void func_80838F5C(PlayState* play, Player* this) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084F88C, 0);

    this->stateFlags1 |= PLAYER_STATE1_IN_CUTSCENE | PLAYER_STATE1_31;
...
s32 Player_HandleExitsAndVoids(PlayState* play, Player* this, CollisionPoly* poly, u32 bgId) {
    ...
    if (this->actor.category == ACTORCAT_PLAYER) {
        ...
        if (!(this->stateFlags1 & PLAYER_STATE1_7) && (play->transitionTrigger == TRANS_TRIGGER_OFF) &&
            ...
            if (!(this->stateFlags1 & (PLAYER_STATE1_23 | PLAYER_STATE1_27 | PLAYER_STATE1_IN_CUTSCENE)) &&
            ...
            if (!(this->stateFlags1 & (PLAYER_STATE1_23 | PLAYER_STATE1_IN_CUTSCENE)) &&
    ...
    if ((this->doorType != PLAYER_DOORTYPE_NONE) &&
        ...
        if (CHECK_BTN_ALL(sControlInput->press.button, BTN_A) || (Player_Action_8084F9A0 == this->actionFunc)) {
            ...
            if (this->doorType == PLAYER_DOORTYPE_SLIDING) {
                ...
                PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80845EF8, 0);
                func_80832528(play, this);
...
void func_80839E88(Player* this, PlayState* play) {
    ...
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80840450, 1);
...
void func_80839F30(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_808407CC, 1);
    Player_AnimChangeOnceMorph(play, this, func_80833338(this));
    this->yaw = this->actor.shape.rot.y;
}
...
void func_80839FFC(Player* this, PlayState* play) {
    ...
    if (func_8008E9C4(this)) {
        ...
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80840BC8, 1);
    }
}
...
void func_8083A0F4(PlayState* play, Player* this) {
    if (func_8083A0D4(this)) {
        ...
        if (interactActorId == ACTOR_BG_TOKI_SWD) {
            ...
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084F608, 0);
            this->stateFlags1 |= PLAYER_STATE1_IN_CUTSCENE;
        } else {
            LinkAnimationHeader* anim;

            if (interactActorId == ACTOR_BG_HEAVY_BLOCK) {
                PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80846120, 0);
                this->stateFlags1 |= PLAYER_STATE1_IN_CUTSCENE;
                anim = &gPlayerAnim_link_normal_heavy_carry;
            } else if ((interactActorId == ACTOR_EN_ISHI) && ((interactRangeActor->params & 0xF) == 1)) {
                PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80846260, 0);
                ...
                PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80846408, 0);
                ...
                PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80846050, 0);
...
void func_8083A2F8(PlayState* play, Player* this) {
    ...
    this->stateFlags1 |= PLAYER_STATE1_6 | PLAYER_STATE1_IN_CUTSCENE;

    if (this->actor.textId != 0) {
        Message_StartTextbox(play, this->actor.textId, this->targetActor);
        this->zTargetActor = this->targetActor;
    }
}
...
void func_8083A388(PlayState* play, Player* this) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084B78C, 0);
}
...
void func_8083A434(PlayState* play, Player* this) {
    ...
    this->stateFlags1 |= PLAYER_STATE1_10 | PLAYER_STATE1_IN_CUTSCENE;
...
void func_8083A5C4(PlayState* play, Player* this, CollisionPoly* arg2, f32 arg3, LinkAnimationHeader* anim) {
    ...
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084BBE4, 0);
    func_80832564(play, this);
    Player_AnimPlayOnce(play, this, anim);
...
void func_8083A9B8(Player* this, LinkAnimationHeader* anim, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084BDFC, 0);
    LinkAnimation_PlayOnceSetSpeed(play, &this->skelAnime, anim, 1.3f);
}
...
void func_8083AA10(Player* this, PlayState* play) {
    ...
    if (!(this->stateFlags1 & (PLAYER_STATE1_27 | PLAYER_STATE1_IN_CUTSCENE)) &&
        !(this->actor.bgCheckFlags & BGCHECKFLAG_GROUND)) {
        if (!func_80838FB8(play, this)) {
            ...
            if (!(this->stateFlags3 & PLAYER_STATE3_1) && !(this->skelAnime.moveFlags & ANIM_FLAG_PLAYER_7) &&
                ...
                if ((this->actor.bgCheckFlags & BGCHECKFLAG_GROUND_LEAVE) && !(this->stateFlags1 & PLAYER_STATE1_27) &&
                    ...
                    if ((sPrevFloorProperty == FLOOR_PROPERTY_11) && !(this->stateFlags1 & PLAYER_STATE1_HOLDING_ACTOR)) {
                        ...
                        if (WaterBox_GetSurface1(play, &play->colCtx, sp44.x, sp44.z, &sp3C, &sp50) &&
                            ...
                            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80844A44, 0);
                            return;
                        }
                    }
...
s32 Player_StartCsAction(PlayState* play, Player* this) {
    ...
    if (this->unk_6AD == 3) {
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_CsAction, 0);
            ...
            if (this->unk_6AD == 4) {
                ...
                if (sp2C >= 0) {
                    if ((sp2C != 3) || (gSaveContext.respawn[RESPAWN_MODE_TOP].data <= 0)) {
                        ...
                        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8085063C, 1);
                        this->stateFlags1 |= PLAYER_STATE1_28 | PLAYER_STATE1_IN_CUTSCENE;
                        Player_AnimPlayOnce(play, this, func_80833338(this));
                ...
                if ((sp2C >= 0) ||
                    ...
                    if ((play->actorCtx.titleCtx.delayTimer == 0) && (play->actorCtx.titleCtx.alpha == 0)) {
                        ...
                        this->stateFlags1 |= PLAYER_STATE1_6 | PLAYER_STATE1_28 | PLAYER_STATE1_IN_CUTSCENE;
                ...
                if (!(this->stateFlags1 & PLAYER_STATE1_23)) {
                    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084B1D8, 1);
...
s32 func_8083B8F4(Player* this, PlayState* play) {
    if (!(this->stateFlags1 & (PLAYER_STATE1_HOLDING_ACTOR | PLAYER_STATE1_23)) &&
...
s32 Player_ActionChange_0(Player* this, PlayState* play) {
    ...
    if ((this->zTargetActor != NULL) && (CHECK_FLAG_ALL(this->zTargetActor->flags, ACTOR_FLAG_0 | ACTOR_FLAG_18) ||
                                    (this->zTargetActor->naviEnemyId != NAVI_ENEMY_NONE))) {
        this->stateFlags2 |= PLAYER_STATE2_21;
...
void func_8083BA90(PlayState* play, Player* this, s32 arg2, f32 xzSpeed, f32 yVelocity) {
    ...
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80844AF4, 0);
...
void func_8083BC04(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80844708, 0);
...
s32 Player_ActionChange_11(Player* this, PlayState* play) {
    ...
    if ((play->shootingGalleryStatus == 0) && (this->currentShield != PLAYER_SHIELD_NONE) &&
        CHECK_BTN_ALL(sControlInput->cur.button, BTN_R) &&
        (Player_IsChildWithHylianShield(this) || (!func_80833B2C(this) && (this->zTargetActor == NULL)))) {

        func_80832318(this);
        Player_DetachHeldActor(play, this);

        if (PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80843188, 0)) {
            this->stateFlags1 |= PLAYER_STATE1_22;
...
s32 func_8083C61C(PlayState* play, Player* this) {
    if ((play->roomCtx.curRoom.behaviorType1 != ROOM_BEHAVIOR_TYPE1_2) &&
        ...
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084E604, 0);
...
s32 func_8083C6B8(PlayState* play, Player* this) {
    ...
    if (sUseHeldItem) {
        if (Player_GetBottleHeld(this) >= 0) {
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084ECA4, 0);
        ...
        if (this->heldItemAction == PLAYER_IA_FISHING_POLE) {
            ...
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80850C68, 0);
            this->unk_860 = 1;
            Player_ZeroSpeedXZ(this);
...
void func_8083C858(Player* this, PlayState* play) {
    ...
    if (func_80833BCC(this)) {
        ...
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084227C, 1);
    } else {
        actionFunc = Player_Action_80842180;
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80842180, 1);
    }
...
s32 func_8083C910(PlayState* play, Player* this, f32 arg2) {
    ...
    if (WaterBox_GetSurface1(play, &play->colCtx, this->actor.world.pos.x, this->actor.world.pos.z, &sp28, &sp2C) !=
        ...
        if (this->ageProperties->unk_24 <= sp28) {
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084D7C4, 0);
            Player_AnimChangeLoopSlowMorph(play, this, &gPlayerAnim_link_swimer_swim);
            this->stateFlags1 |= PLAYER_STATE1_27 | PLAYER_STATE1_IN_CUTSCENE;
            this->av2.actionVar2 = 20;
            this->speedXZ = 2.0f;
...
void func_8083CB2C(Player* this, s16 yaw, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_808414F8, 1);
...
void func_8083CB94(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80840DE4, 1);
...
void func_8083CBF0(Player* this, s16 yaw, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_808423EC, 1);
...
void func_8083CC9C(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084193C, 1);
...
void func_8083CD00(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084251C, 1);
...
void func_8083CD54(PlayState* play, Player* this, s16 yaw) {
    this->yaw = yaw;
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80841BA8, 1);
    this->unk_87E = 1200;
...
s32 func_8083D12C(PlayState* play, Player* this, Input* arg2) {
    if (!(this->stateFlags1 & PLAYER_STATE1_10) && !(this->stateFlags2 & PLAYER_STATE2_10)) {
        if ((arg2 == NULL) || (CHECK_BTN_ALL(arg2->press.button, BTN_A) && (ABS(this->unk_6C2) < 12000) &&
            ...
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084DC48, 0);
    ...
    if ((this->stateFlags1 & PLAYER_STATE1_10) || (this->stateFlags2 & PLAYER_STATE2_10)) {
        if (this->actor.velocity.y > 0.0f) {
            if (this->actor.yDistToWater < this->ageProperties->unk_30) {
                ...
                if (arg2 != NULL) {
                    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084E1EC, 1);

                    if (this->stateFlags1 & PLAYER_STATE1_10) {
                        this->stateFlags1 |= PLAYER_STATE1_10 | PLAYER_STATE1_HOLDING_ACTOR | PLAYER_STATE1_IN_CUTSCENE;
                    }
...
void func_8083D36C(PlayState* play, Player* this) {
    if ((this->currentBoots != PLAYER_BOOTS_IRON) || !(this->actor.bgCheckFlags & BGCHECKFLAG_GROUND)) {
        ...
        if ((this->currentBoots != PLAYER_BOOTS_IRON) && (this->stateFlags2 & PLAYER_STATE2_10)) {
            ...
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084D610, 1);
            Player_AnimChangeOnceMorph(play, this,
                                       (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND)
...
s32 func_8083DB98(Player* this, s32 arg1) {
    Actor* zTargetActor = this->zTargetActor;
    Vec3f sp30;
    s16 sp2E;
    s16 sp2C;
    ...
    sp2E = Math_Vec3f_Pitch(&sp30, &zTargetActor->focus.pos);
    sp2C = Math_Vec3f_Yaw(&sp30, &zTargetActor->focus.pos);
...
s32 Player_HandleSlopes(PlayState* play, Player* this, CollisionPoly* floorPoly) {
    ...
    if (!Player_InBlockingCsMode(play, this) && (Player_Action_8084F390 != this->actionFunc) &&
        ...
        if (ABS(velYawToDownwardSlope) > 0x3E80) { // 87.9 degrees
            ...
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084F390, 0);
            func_80832564(play, this);
...
void func_8083EA94(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80846578, 1);
    ...
    if ((this->stateFlags1 & PLAYER_STATE1_HOLDING_ACTOR) && (this->heldActor != NULL) &&
        ...
        if (!func_80835644(play, this, this->heldActor)) {
            if (!func_8083EAF0(this, this->heldActor)) {
                PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_808464B0, 1);
...
s32 Player_TryEnteringCrawlspace(Player* this, PlayState* play, u32 interactWallFlags) {
    ...
    if (!(this->stateFlags1 & PLAYER_STATE1_27) && (interactWallFlags & WALL_FLAG_CRAWLSPACE)) {
...
s32 Player_TryLeavingCrawlspace(Player* this, PlayState* play) {
    ...
    if ((this->speedXZ != 0.0f) && (this->actor.bgCheckFlags & BGCHECKFLAG_WALL) &&
        ...
        if (ABS(yawToWall) > 0x4000) {
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084C81C, 0);
...
void func_8083FAB8(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084B898, 0);
    this->stateFlags2 |= PLAYER_STATE2_4;
    Player_AnimPlayOnce(play, this, &gPlayerAnim_link_normal_push_start);
}

void func_8083FB14(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084B9E4, 0);
    this->stateFlags2 |= PLAYER_STATE2_4;
...
s32 func_8083FD78(Player* this, f32* arg1, s16* arg2, PlayState* play) {
    ...
    if ((func_8002DD78(this) || func_808334B4(this)) && (this->zTargetActor == NULL)) {
        *arg1 *= Math_SinS(sp2C);
...
void func_8084140C(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084170C, 1);
...
void func_808416C0(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_808417FC, 1);
...
void func_80842D20(PlayState* play, Player* this) {
    ...
    if (Player_Action_80843188 != this->actionFunc) {
        func_80832440(play, this);
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_808505DC, 0);
...
void Player_Action_808435C4(Player* this, PlayState* play) {
    ...
    if (this->av1.actionVar1 == 0) {
        ...
        if ((temp != 0) && ((temp > 0) || LinkAnimation_Update(play, &this->skelAnime))) {
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80843188, 1);
            this->stateFlags1 |= PLAYER_STATE1_22;
            Player_SetModelsForHoldingShield(this);
            anim = GET_PLAYER_ANIM(PLAYER_ANIMGROUP_defense, this->modelAnimType);
    ...
    if (LinkAnimation_Update(play, &this->skelAnime) && (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND)) {
        if (this->av2.actionVar2 != 0) {
            ...
            if (this->stateFlags1 & PLAYER_STATE1_IN_CUTSCENE) {
                ...
                PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80843954, 0);
                this->stateFlags1 |= PLAYER_STATE1_26;
            }
...
void Player_Action_80843954(Player* this, PlayState* play) {
    ...
    if (LinkAnimation_Update(play, &this->skelAnime) && (this->speedXZ == 0.0f)) {
        if (this->stateFlags1 & PLAYER_STATE1_IN_CUTSCENE) {
            ...
            PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80843A38, 0);
            this->stateFlags1 |= PLAYER_STATE1_26;
        }
        ...
        if (((this->stateFlags2 & PLAYER_STATE2_19) && (this->av1.actionVar1 == 2)) || !func_8083BBA0(this, play)) {
            if (this->actor.velocity.y < 0.0f) {
                if (this->av2.actionVar2 >= 0) {
                    ...
                    if ((this->actor.bgCheckFlags & BGCHECKFLAG_PLAYER_WALL_INTERACT) &&
                        !(this->stateFlags2 & PLAYER_STATE2_19) &&
                        !(this->stateFlags1 & (PLAYER_STATE1_HOLDING_ACTOR | PLAYER_STATE1_27)) && (this->speedXZ > 0.0f)) {
...
void func_80844CF8(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80845000, 1);
}

void func_80844D30(Player* this, PlayState* play) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80845308, 1);
}
...
void Player_Action_80846260(Player* this, PlayState* play) {
    ...
    if (this->av2.actionVar2 == 0) {
        ...
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80846358, 1);
...
static ColliderCylinderInit sLinkBodyCollider = {
    {
        COLTYPE_HIT5,
        AT_NONE,
        AC_ON | AC_TYPE_ENEMY,
...
static ColliderQuadInit sWeaponCollider = {
    {
        COLTYPE_NONE,
...
static ColliderQuadInit sShieldCollider = {
    {
        COLTYPE_METAL,
        AT_ON | AT_TYPE_PLAYER,
...
void func_80846660(PlayState* play, Player* this) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084F710, 0);
...
void func_808467D4(PlayState* play, Player* this) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084E9AC, 0);
    this->stateFlags1 |= PLAYER_STATE1_IN_CUTSCENE;
...
void func_808468A8(PlayState* play, Player* this) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084F9A0, 0);
    Player_AnimReplaceApplyFlags(play, this,
                                 ANIM_FLAG_0 | ANIM_FLAG_UPDATE_Y | ANIM_FLAG_PLAYER_SETMOVE | ANIM_FLAG_NO_MOVE |
                                     ANIM_FLAG_PLAYER_7);
}
...
void func_808468E8(PlayState* play, Player* this) {
    ...
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084F9C0, 0);
    this->stateFlags1 |= PLAYER_STATE1_IN_CUTSCENE;
    this->fallStartHeight = this->actor.world.pos.y;
...
void func_808469BC(PlayState* play, Player* this) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084F698, 0);
    this->actor.draw = NULL;
    this->stateFlags1 |= PLAYER_STATE1_IN_CUTSCENE;
}
...
void func_80846A68(PlayState* play, Player* this) {
    this->actor.draw = NULL;
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8085076C, 0);
    this->stateFlags1 |= PLAYER_STATE1_IN_CUTSCENE;
}
...
void Player_InitCommon(Player* this, PlayState* play, FlexSkeletonHeader* skelHeader) {
    ...
    Collider_SetCylinder(play, &this->cylinder, &this->actor, &sLinkBodyCollider);
    Collider_InitQuad(play, &this->meleeWeaponQuads[0]);
    Collider_SetQuad(play, &this->meleeWeaponQuads[0], &this->actor, &sWeaponCollider);
    Collider_InitQuad(play, &this->meleeWeaponQuads[1]);
    Collider_SetQuad(play, &this->meleeWeaponQuads[1], &this->actor, &sWeaponCollider);
    Collider_InitQuad(play, &this->shieldQuad);
    Collider_SetQuad(play, &this->shieldQuad, &this->actor, &sShieldCollider);
}
...
#define vWallCheckHeight float1
    ...
    if (this->stateFlags1 & (PLAYER_STATE1_IN_CUTSCENE | PLAYER_STATE1_31)) {
...
void Player_UpdateCamAndSeqModes(PlayState* play, Player* this) {
    ...
    if (this->actor.category == ACTORCAT_PLAYER) {
        ...
        if (this->csAction != PLAYER_CSACTION_NONE) {
            ...
            if ((this->actor.parent != NULL) && (this->stateFlags3 & PLAYER_STATE3_7)) {
            ...
            } else if ((zTargetActor = this->zTargetActor) != NULL) {
                ...
                Camera_SetViewParam(Play_GetCamera(play, CAM_ID_MAIN), CAM_VIEW_TARGET, zTargetActor);
...
void Player_UpdateCommon(Player* this, PlayState* play, Input* input) {
    ...
    if (this->stateFlags2 & PLAYER_STATE2_PAUSE_MOST_UPDATING) {
        ...
        if (!(this->skelAnime.moveFlags & ANIM_FLAG_PLAYER_7)) {
            ...
            if (!(this->stateFlags1 & PLAYER_STATE1_EXITING_SCENE) && (this->stateFlags1 & PLAYER_STATE1_23)) {
                EnHorse* rideActor = (EnHorse*)this->rideActor;
                CollisionPoly* sp5C;
                s32 sp58;
                Vec3f sp4C;
        ...
        if ((this->zTargetActor == NULL) && (this->naviTextId == 0)) {
            this->stateFlags2 &= ~(PLAYER_STATE2_1 | PLAYER_STATE2_21);
        }

        this->stateFlags1 &= ~(PLAYER_STATE1_SWINGING_BOTTLE | PLAYER_STATE1_9 | PLAYER_STATE1_12 | PLAYER_STATE1_22);
        this->stateFlags2 &= ~(PLAYER_STATE2_0 | PLAYER_STATE2_2 | PLAYER_STATE2_3 | PLAYER_STATE2_5 | PLAYER_STATE2_ALWAYS_DISABLE_MOVE_ROTATION |
    ...
    if (this->stateFlags1 & (PLAYER_STATE1_7 | PLAYER_STATE1_28 | PLAYER_STATE1_IN_CUTSCENE)) {
...
void Player_Update(Actor* thisx, PlayState* play) {
    ...
    if (func_8084FCAC(this, play)) {
        ...
        if (this->stateFlags1 & (PLAYER_STATE1_5 | PLAYER_STATE1_IN_CUTSCENE)) {
...
s32 func_8084B3CC(PlayState* play, Player* this) {
    if (play->shootingGalleryStatus != 0) {
        func_80832564(play, this);
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084FA54, 0);
...
void Player_Action_8084B78C(Player* this, PlayState* play) {
    ...
    this->stateFlags2 |= PLAYER_STATE2_0 | PLAYER_STATE2_ALWAYS_DISABLE_MOVE_ROTATION | PLAYER_STATE2_8;
...
void func_8084D574(PlayState* play, Player* this, s16 arg2) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084D84C, 0);
    this->actor.shape.rot.y = this->yaw = arg2;
    Player_AnimChangeLoopSlowMorph(play, this, &gPlayerAnim_link_swimer_swim);
}

void func_8084D5CC(PlayState* play, Player* this) {
    PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084DAB4, 0);
    Player_AnimChangeLoopSlowMorph(play, this, &gPlayerAnim_link_swimer_swim);
}
...
void func_8084DF6C(PlayState* play, Player* this) {
    this->unk_862 = 0;
    this->stateFlags1 &= ~(PLAYER_STATE1_10 | PLAYER_STATE1_HOLDING_ACTOR);
    this->getItemId = GI_NONE;
    Camera_SetFinishedFlag(Play_GetCamera(play, CAM_ID_MAIN));
}
...
void Player_Action_8084F104(Player* this, PlayState* play) {
    ...
    if ((this->av1.actionVar1 == 0) && (this->zTargetActor != NULL)) {
        this->yaw = this->actor.shape.rot.y = func_8083DB98(this, 0);
    }
}
...
void Player_Action_80850C68(Player* this, PlayState* play) {
    ...
    if (this->unk_860 == 0) {
        ...
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_80850E84, 0);
...
void func_80851314(Player* this) {
    ...
    this->zTargetActor = this->csActor;
...
s32 func_80852F38(PlayState* play, Player* this) {
    if (!Player_InBlockingCsMode(play, this) && (this->invincibilityTimer >= 0) && !func_8008F128(this) &&
        !(this->stateFlags3 & PLAYER_STATE3_7)) {
        func_80832564(play, this);
        PLAYER_SETUPACTIONFUNC_DEBUG(play, this, Player_Action_8084F308, 0);
